...
// EXTERNAL MODULE: ./node_modules/typewind/dist/index.js
var dist = __webpack_require__(150);
;// CONCATENATED MODULE: ./node_modules/tailwind-variants/dist/chunk-X3I5ASPE.js
var chunk_X3I5ASPE_s=e=>typeof e=="boolean"?`${e}`:e===0?"0":e,chunk_X3I5ASPE_f=e=>!e||typeof e!="object"||Object.keys(e).length===0,c=(...e)=>[...e].flat().filter(Boolean),p=(e,r)=>{let n={};for(let t in e)r!=null&&r.hasOwnProperty(t)?n[t]=typeof e[t]=="object"?p(e[t],r[t]):r[t]+" "+e[t]:n[t]=e[t];for(let t in r)n.hasOwnProperty(t)||(n[t]=r[t]);return n},chunk_X3I5ASPE_o=e=>!e||typeof e!="string"?e:e.replace(/\s+/g," ").trim();
...
var Q={twMerge:!0,twMergeConfig:{},responsiveVariants:!1},X=e=>e||void 0,v=(...e)=>X(e.flat(1/0).filter(Boolean).join(" ")),h=(...e)=>(c=Q)=>{if(!c.twMerge)return v(e);let d=chunk_X3I5ASPE_f(c.twMergeConfig)?twMerge:extendTailwindMerge(c.twMergeConfig);return X(d(v(e)))},L=(e,c)=>{let d={...e};for(let b in c)d.hasOwnProperty(b)?d[b]=v(d[b],c[b]):d[b]=c[b];return d},fe=(e$1,c$1=Q)=>{var B,N,T,k,F;let{slots:d$1={},variants:b$1={},compoundVariants:j=[],compoundSlots:V=[],defaultVariants:Y={}}=e$1,w=v((B=e$1==null?void 0:e$1.extend)==null?void 0:B.base,e$1==null?void 0:e$1.base),i=p(b$1,(N=e$1==null?void 0:e$1.extend)==null?void 0:N.variants),C=Object.assign({},(T=e$1==null?void 0:e$1.extend)==null?void 0:T.defaultVariants,Y),M=chunk_X3I5ASPE_f(d$1)?{}:{base:e$1==null?void 0:e$1.base,...d$1},Z=Array.isArray(c$1.responsiveVariants)&&c$1.responsiveVariants.length>0||c$1.responsiveVariants===!0,x=chunk_X3I5ASPE_f((k=e$1==null?void 0:e$1.extend)==null?void 0:k.slots)?M:L((F=e$1==null?void 0:e$1.extend)==null?void 0:F.slots,chunk_X3I5ASPE_f(M)?{base:e$1==null?void 0:e$1.base}:M),g=u=>{var W,q,z,D;if(chunk_X3I5ASPE_f(i)&&chunk_X3I5ASPE_f(d$1)&&chunk_X3I5ASPE_f((W=e$1==null?void 0:e$1.extend)==null?void 0:W.slots))return h(w,u==null?void 0:u.class,u==null?void 0:u.className)(c$1);if(j&&!Array.isArray(j))throw new TypeError(`The "compoundVariants" prop must be an array. Received: ${typeof j}`);if(V&&!Array.isArray(V))throw new TypeError(`The "compoundSlots" prop must be an array. Received: ${typeof V}`);let K=(t,r,n=[],s)=>{let l=n;if(typeof r=="string")l.push(chunk_X3I5ASPE_o(r).split(" ").map(a=>`${t}:${a}`));else if(Array.isArray(r))l.push(r.flatMap(a=>`${t}:${a}`));else if(typeof r=="object"&&typeof s=="string"){let a=r==null?void 0:r[s];if(a&&typeof a=="string"){let f=chunk_X3I5ASPE_o(a);l[s]=l[s]?[...l[s],...f.split(" ").map(m=>`${t}:${m}`)]:f.split(" ").map(m=>`${t}:${m}`);}else Array.isArray(a)&&a.length>0&&(l[s]=a.flatMap(f=>`${t}:${f}`));}return l},R=(t,r=i,n=null)=>{let s=r==null?void 0:r[t];if(typeof s!="object"||chunk_X3I5ASPE_f(s))return null;let l=u==null?void 0:u[t],a$1=C==null?void 0:C[t],f=[];if(l===null)return null;let m=chunk_X3I5ASPE_s(l);typeof m=="object"&&Z&&(f=Object.keys(m).reduce(($,O)=>{let G=m[O],ae=s==null?void 0:s[G];return O==="initial"?(a$1=G,$):Array.isArray(c$1.responsiveVariants)&&!c$1.responsiveVariants.includes(O)?$:K(O,ae,$,n)},[]));let A=s[m]||s[chunk_X3I5ASPE_s(a$1)];return typeof f=="object"&&typeof n=="string"&&f[n]?L(f,A):f.length>0?[A,...f]:A},o=()=>i?Object.keys(i).map(t=>R(t,i)):null,p=t=>!i||typeof i!="object"?null:Object.keys(i).map(r=>{let n=R(r,i,t);return t==="base"&&typeof n=="string"?n:n&&n[t]}).filter(Boolean),ee=u&&Object.fromEntries(Object.entries(u).filter(([,t])=>t!==void 0)),I=t=>{var n;let r=typeof(u==null?void 0:u[t])=="object"?{[t]:(n=u[t])==null?void 0:n.initial}:{};return {...C,...ee,...r}},P=(t=[])=>t==null?void 0:t.filter(({class:r,className:n,...s})=>Object.entries(s).every(([l,a])=>{let f=I(l);return Array.isArray(a)?a.includes(f[l]):f[l]===a})).flatMap(({class:r,className:n})=>[r,n]),U=()=>{var n;let t=P(j),r=P((n=e$1==null?void 0:e$1.extend)==null?void 0:n.compoundVariants);return c(r,t)},te=()=>{let t=U();return Array.isArray(t)?t.reduce((r,n)=>(typeof n=="string"&&(r.base=h(r.base,n)(c$1)),typeof n=="object"&&Object.entries(n).forEach(([s,l])=>{r[s]=h(r[s],l)(c$1);}),r),{}):t},re=()=>V.length<1?null:V.reduce((t,r)=>{let{slots:n=[],class:s,className:l,...a}=r;if(!chunk_X3I5ASPE_f(a)){let f=Object.keys(a);for(let m of f){let A=I(m)[m];if(!A||A!==a[m])return t}}return n.forEach(f=>{t[f]||(t[f]=[]),t[f].push([s,l]);}),t},{});if(!chunk_X3I5ASPE_f(d$1)||!chunk_X3I5ASPE_f((q=e$1==null?void 0:e$1.extend)==null?void 0:q.slots)){let t=(z=te())!=null?z:[],r=(D=re())!=null?D:[];return {...typeof x=="object"&&!chunk_X3I5ASPE_f(x)?Object.keys(x).reduce((s,l)=>(s[l]=a=>h(x[l],p(l),t==null?void 0:t[l],r==null?void 0:r[l],a==null?void 0:a.class,a==null?void 0:a.className)(c$1),s),{}):{}}}return h(w,o(),U(),u==null?void 0:u.class,u==null?void 0:u.className)(c$1)},_=()=>{if(!(!i||typeof i!="object"))return Object.keys(i)};return g.variantKeys=_(),g.base=w,g.slots=x,g.variants=i,g.defaultVariants=C,g.compoundSlots=V,g.compoundVariants=j,g};
...
var box = fe({
  base: "text-white mobile:p-inset-200 tablet:p-inset-300 desktop:p-inset-400",
  variants: {
    foo: {
      success: "bg-green-600 desktop:mx-offset-200",
      error: "bg-background-danger-prominent desktop:mx-offset-400",
      info: "bg-background-primary-prominent desktop:mx-offset-600"
    },
    ghost: {
      "true": "opacity-30"
    }
